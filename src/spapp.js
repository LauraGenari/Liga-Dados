...
(function($,window){
    ...
    function show(pageName,param) {
      ...
      if(currentPageName) { // "close" current page view
        $(document.body.getElementsByTagName("span")).removeClass(currentPageName); // remove old page class {
        if($currentPage) {
      ...
      $(document.body.getElementsByTagName("span")).addClass(currentPageName = pageName); // set new page class
      if($currentPage = $page)
    ...
    function app(pageName,param) {
      ...
      var $page = $(document.body.getElementsByTagName("span")).find("section#" + pageName);
